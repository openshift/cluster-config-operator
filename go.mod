...
require (
	...
	github.com/openshift/client-go v0.0.0-20260626205214-7df9f8afeb8e
...
replace github.com/openshift/api => github.com/jeff-roche/api v0.0.0-20260922173412-c94f2ba75cf2
