...
var map_NodeSpec = map[string]string{
	...
	"enablePodEvents":      "EnablePodEvents determines whether to enable the evented pleg feature to send the container events from the CRI-O through gRPC to the Kubelet",
}
